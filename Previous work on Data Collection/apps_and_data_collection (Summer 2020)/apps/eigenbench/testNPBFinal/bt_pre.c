...
static double us[64/2*2+1][64/2*2+1][64/2*2+1];
static double vs[64/2*2+1][64/2*2+1][64/2*2+1];
static double ws[64/2*2+1][64/2*2+1][64/2*2+1];
static double qs[64/2*2+1][64/2*2+1][64/2*2+1];
static double rho_i[64/2*2+1][64/2*2+1][64/2*2+1];
static double square[64/2*2+1][64/2*2+1][64/2*2+1];
static double forcing[64/2*2+1][64/2*2+1][64/2*2+1][5+1];
static double u[(64 +1)/2*2+1][(64 +1)/2*2+1][(64 +1)/2*2+1][5];
static double rhs[64/2*2+1][64/2*2+1][64/2*2+1][5];
static double lhs[64/2*2+1][64/2*2+1][64/2*2+1][3][5][5];
...
static double fjac[64/2*2+1][64/2*2+1][64 -1+1][5][5];
static double njac[64/2*2+1][64/2*2+1][64 -1+1][5][5];
...
#pragma omp parallel
{
  ...
  energymonitor__setfilename("bt.csv");
...
#pragma omp master
 ...
 (3478.8*(double)n3-17655.7*((navg)*(navg))+28023.7*navg) / tmax;
  ...
  c_print_results("BT", class, grid_points[0],
    ...
    verified, "2.3","10 Sep 2016", "gcc", "g++", "-lenergymodule", "-I../common -I../../../workspace/testmonito...", "-O3 -lm -fopenmp -lenergymodule ",
    "(none)", "(none)");
}
static void add(void) {
  int i, j, k, m;
