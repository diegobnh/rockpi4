...
do
  ...
  if [[ "$threads" == "2" ]]; then
    ...
    sudo taskset -a -c 4-5 ./../../../data_collection/bin/scheduler_A72  ./$filename
    sudo rm -r ../pmcs/"2b_${filename}_pmcs"
    mkdir ../pmcs/"2b_${filename}_pmcs"
    mv *.csv ../pmcs/"2b_${filename}_pmcs"
    mv *.txt ../pmcs/"2b_${filename}_pmcs"
  ...
  #4 little configuration
    ...
    sudo taskset -a -c 0-3 ./../../../data_collection/bin/scheduler_A53  ./$filename
    sudo rm -r ../pmcs/"4l_${filename}_pmcs"
    mkdir ../pmcs/"4l_${filename}_pmcs"
    mv *.csv ../pmcs/"4l_${filename}_pmcs"
    mv *.txt ../pmcs/"4l_${filename}_pmcs"
  ...
  #4 little and 2 big configuration
    ...
    sudo taskset -a -c 0-5 ./../../../data_collection/bin/scheduler_A72  ./$filename
    sudo rm -r ../pmcs/"4l2b_A72_${filename}_pmcs"
    mkdir ../pmcs/"4l2b_A72_${filename}_pmcs"
    mv *.csv ../pmcs/"4l2b_A72_${filename}_pmcs"
    mv *.txt ../pmcs/"4l2b_A72_${filename}_pmcs"
    ...
    sudo taskset -a -c 0-5 ./../../../data_collection/bin/scheduler_A53  ./$filename
    sudo rm -r ../pmcs/"4l2b_A53_${filename}_pmcs"
    mkdir ../pmcs/"4l2b_A53_${filename}_pmcs"
    mv *.csv ../pmcs/"4l2b_A53_${filename}_pmcs"
    mv *.txt ../pmcs/"4l2b_A53_${filename}_pmcs"
