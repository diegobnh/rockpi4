...
static void update_scheduler()
{
    ...
    if(current_state==STATE_4l)
    {
        while(num_samples<20)
        {
            ...
            {   //Exponential Moving Averages (EMA)
                ...
                l_pmc_1 = l_pmc_2 = l_pmc_3 = l_pmc_4 = l_pmc_5 = 0;
            }
            else{
    ...
    else if(current_state==STATE_4b)
    {
        while(num_samples<20)
        {
    ...
    else if(current_state==STATE_4l4b)
    {
    ...
    send_to_scheduler("%.6lf,%.6lf,%.6lf,%.6lf,%.6lf,%.6lf,%.6lf,%.6lf,%.6lf,%.6lf,%d", \
                      average_l_pmcs[1]/average_l_pmcs[0], 100*(average_l_pmcs[2]/average_l_pmcs[1]), 100*(average_l_pmcs[3]/average_l_pmcs[1]), 100*(average_l_pmcs[4]/average_l_pmcs[1]), \
                      average_b_pmcs[1]/average_b_pmcs[0], 100*(average_b_pmcs[2]/average_b_pmcs[1]), 100*(average_b_pmcs[3]/average_b_pmcs[1]), 100*(average_b_pmcs[4]/average_b_pmcs[1]), \
                      100*(average_b_pmcs[5]/average_b_pmcs[1]), 100*(average_b_pmcs[6]/average_b_pmcs[1]), \
                      current_state);
    //send_to_scheduler("%.6lf,%.6lf,%.6lf,%.6lf,%.6lf,%.6lf,%.6lf,%.6lf,%.6lf,%.6lf,%d", \
    //                  l_pmc_2/l_pmc_1, 100*(l_pmc_3/l_pmc_2), 100*(l_pmc_4/l_pmc_2), 100*(l_pmc_5/l_pmc_2), \
    //                  b_pmc_2/b_pmc_1, 100*(b_pmc_3/b_pmc_2), 100*(b_pmc_4/b_pmc_2), 100*(b_pmc_5/b_pmc_2), 100*(b_pmc_6/b_pmc_2), 100*(b_pmc_7/b_pmc_2), \
    //                  current_state);
...
int main(int argc, char* argv[])
{
   ...
   */
   ...
   char commands[][256]= { "/home/odroid/workloads/bots/bin/fib.gcc.omp-tasks -o 0 -n 32",
                           "/home/odroid/workloads/bots/bin/nqueens.gcc.omp-tasks -n 12",
                           "/home/odroid/workloads/bots/bin/health.gcc.omp-tasks -o 0 -f /home/odroid/workloads/bots/inputs/health/medium.input",
                           "/home/odroid/workloads/bots/bin/floorplan.gcc.omp-tasks -o 0 -f /home/odroid/workloads/bots/inputs/floorplan/input.15",
                           "/home/odroid/workloads/bots/bin/fft.gcc.omp-tasks -o 0 -n 1000000",
                           "/home/odroid/workloads/bots/bin/sort.gcc.omp-tasks -o 0 -n 100000000",
                           "/home/odroid/workloads/bots/bin/sparselu.gcc.for-omp-tasks -o 0 -n 75 -m 75",
                           "/home/odroid/workloads/bots/bin/strassen.gcc.omp-tasks -o 0 -n 4096",
                           "/home/odroid/workloads/rodinia/openmp/backprop/backprop 2000000",
                           "/home/odroid/workloads/rodinia/openmp/heartwall/heartwall /home/odroid/workloads/rodinia/data/heartwall/test.avi.part00 25",
                           "/home/odroid/workloads/rodinia/openmp/lavaMD/lavaMD -boxes1d 10",
                           "/home/odroid/workloads/rodinia/openmp/particlefilter/./particle_filter -x 256 -y 256 -z 20 -np 20000"};
